...
class DnDStorage:
    ...
    def _get_campaign_file(self, campaign_name: Optional[str] = None) -> Path:
    ...
    # Campaign Management
    def create_campaign(self, name: str, description: str, dm_name: Optional[str] = None, setting: Optional[str] = None) -> Campaign:
    ...
    def list_quests(self, status: Optional[str] = None) -> List[str]:
    ...
    def get_events(self, limit: Optional[int] = None, event_type: Optional[str] = None) -> List[AdventureEvent]:
